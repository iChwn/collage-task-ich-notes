$(function() {
  ...
  $("#btn-n-add").on('click', function(event) {
      ...
      $html = `<div class="col-md-4 single-note-item all-category">
                  <div class="card card-body dark-cardbg">
                    <span class="side-stick"></span>
                    <h5 class="note-title text-truncate w-75 mb-0 text-white" data-noteHeading="${$_noteTitle}">${$_noteTitle}<i class="point fa fa-circle ml-1 font-10"></i></h5> 
                    <p class="note-date font-12 text-warning">today</p> 
                    <div class="note-content text-white"> 
                        <p class="note-inner-content" >${$_noteDescription}</p> 
                    </div> 
                    <div class="d-flex align-items-center"> 
                        <span class="mr-1"><i class="fa fa-star favourite-note"></i></span> 
                        <span class="mr-1"><i class="fa fa-trash remove-note text-danger"></i></span> 
                        <div class="ml-auto"> 
  ...
  $('#addnotesmodal').on('hidden.bs.modal', function (event) {
      ...
      $('#note-has-description').summernote('code', '');
  })
